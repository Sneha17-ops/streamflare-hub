...
try {
  const envFlag = typeof process.env.REDIS_ENABLED !== "undefined" ? process.env.REDIS_ENABLED : null;
  const hasRedisUrl = Boolean(process.env.REDIS_URL);
  const shouldInitRedis = envFlag === "true" || (process.env.NODE_ENV === "production" && hasRedisUrl);
